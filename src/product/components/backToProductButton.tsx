...
export const BackToProductButton = component$(() =>{
    ...
    return (
        <>
            <Link href="/"  aria-aria-label="back-to-products" class="border border-palette-primary text-palette-primary text-lg font-primary font-semibold pt-2 pb-1 leading-relaxed flex 
