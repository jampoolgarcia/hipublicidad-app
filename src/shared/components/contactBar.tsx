...
export const ContactBar = component$(() =>{
    return (
        <div class="bg-[#fafafb] flex justify-around items-center">
            <div>
                ...
                <Link href="/contact" class="text-xs transition-colors duration-300 ml-4 hover:text-blue-600 "><i class="fa-solid fa-envelope"></i> test@gmail.com</Link>
            </div>
            <div>
