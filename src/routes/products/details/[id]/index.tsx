...
export default component$(() =>{
    ...
    return (
      <section class="relative flex flex-col mt-10 mb-6 p-5 justify-center items-center md:flex-row md:items-start space-y-8 md:space-y-0 md:space-x-4 lg:space-x-8 w-11/12 mx-auto">
